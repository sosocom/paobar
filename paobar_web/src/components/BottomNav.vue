<template>
  <nav class="fixed bottom-0 left-0 right-0 bg-background-card/95 backdrop-blur-xl border-t border-white/5 z-50">
...
const navItems = [
  ...
  { name: 'crawler', path: '/crawler', label: '扒谱', icon: Guitar },
