...
public class YopuCrawler {
     ...
     * 爬取吉他谱详情
     */
    public GuitarTab crawlTabDetail(String url) throws IOException {
        ...
        try {
            ...
            if (headerElement != null) {
                ...
                if (targetElement != null) {
                    ...
                    log.info("找到 header 的下一个兄弟节点: <{}>, HTML长度: {}", 
                            targetElement.tagName(), targetHtml.length());
                }
            }
            ...
            if (targetElement == null) {
                ...
                if (targetElement != null) {
                    targetHtml = targetElement.outerHtml();
                    log.info("使用备用选择器找到内容，长度: {}", targetHtml.length());
                }
            }
            ...
            if (!targetHtml.isEmpty()) {
                ...
                log.info("成功保存吉他谱HTML内容，长度: {}", targetHtml.length());
            }
            ...
            log.info("爬取成功: {} - {}, 歌词长度: {}, 图片: {}", 
                    tab.getSongName(), tab.getArtist(), 
                    tab.getLyrics() != null ? tab.getLyrics().length() : 0,
                    tab.getTabImageUrl() != null ? "有" : "无");
            return tab;
